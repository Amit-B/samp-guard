<?php
	...
	else
	{
		...
		switch($func['status'])
		{
			case "0": $status = "<font color=\"green\">הפונקציה אושרה כעובדת.</font>"; break;
			case "1": $status = "<font color=\"orange\">הפונקציה לא נבדקה ולא אושר מאף אחד אם היא עובדת או לא. היא אמורה לעבוד. כדי לאשר את הסטאטוס, שלח <a href=\"http://sa-mp.co.il/private.php?do=newpm&u=2\">הודעה פרטית</a> או <a href=\"mailto:amit@sa-mp.co.il\">מייל</a> ליוצר המערכת.</font>"; break;
			case "2": $status = "<font color=\"red\">הפונקציה נבדקה ונכון לעכשיו היא לא עובדת.</font>"; break;
			case "3": $status = "<font color=\"darkred\">הפונקציה נמחקה ולא ניתנת לשימוש בגרסת המערכת הנוכחית.</font>"; break;
		...
		$func['desc'] . "<br/><br/><b>סטאטוס: " . $status . "</b><br/><b>קטגוריה: </b>" . $func['category'];
	...
	$vars['body1'] .= "<br/><a href=\"index.php?p=dev\">» לחזרה לרשימת הפונקציות...</a><div class=\"cleaner h30\"></div>";
?>